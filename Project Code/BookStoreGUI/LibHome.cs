...
namespace BookStoreGUI
{
    public partial class LibHome : Form
    {
        ...
        private void checkout_Cart_Click_1(object sender, EventArgs e)
        {
            CheckoutCart chkC = new CheckoutCart(userID);
            chkC.setOrderBooks(bookOrder.OrderItemList);
            chkC.ShowDialog();
        }

        private void add_to_Cart_Click_1(object sender, EventArgs e)
        {
            addToCart_Click(sender, e);
        }

        private void view_Review_Click_1(object sender, EventArgs e)
        {
            Int32 selectedRowCount =
            dataGridView1.Rows.GetRowCount(DataGridViewElementStates.Selected);
