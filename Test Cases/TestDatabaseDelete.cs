...
namespace BookStoreLIB
{
    ...
    public class TestDatabaseDelete
    {
        ...
        public class TestDatabaseDelete2
        {
            DBQueries dbQ = new DBQueries();
            DataSet ds = new DataSet();
            DBGetID dbG = new DBGetID();
            ...
            [TestMethod]
            public void TestMethodDeleteFromUserReviews2()
            {
                var c = new SqlConnection(Properties.Settings.Default.dbConnectionString);
                Boolean expectedInsert = true;
                Boolean expectedDelete = true;
                string expectedISBN = "123123";
                int expectedOrderID = 0; //orderID does not exist with 0
                int expectedRating = 5;
                string expectedComments = "good ";
